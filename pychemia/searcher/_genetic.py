...
class GeneticAlgorithm(Searcher):
    ...
    def set_params(self, params):
        ...
        self.nelite = int(self.generation_size - 2 * np.sum(self.crossing_sets))
    ...
    def run_one(self):
        ...
        discarded_index = self.nelite + int(np.sum(self.crossing_sets))
        ...
        jump = 0
        for i in range(len(self.crossing_sets)):
