"""
One core capability of PyChemia is global optimization of atomic structures such as clusters and crystals.
Doing global optimization requires compute forces and energies of hundreds or even thousands of structures and all
these data must be store and processed efficiently.
...
There are two kinds of databases defined on PyChemia: __PyChemiaDB__ is a kind of database to store structure and
properties. __PyChemiaQueue__ is a repository of calculations.
...
To do a more efficient executiion of calculations using several computer clusters and dedicated machines,
PyChemia provides a central database of calculations that can be used to feed clusters with execution jobs.
The PyChemiaQueue is used to fill the role of a meta-queue for structures and jobs that need to be computed.
